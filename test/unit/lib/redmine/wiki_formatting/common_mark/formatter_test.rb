  ...
  * Two
    ...
    def test_should_support_task_list
      ...
      expected = <<~EXPECTED
        ...
        <input type="checkbox" class="task-list-item-checkbox" disabled checked="checked"> Task 1
        </li>
        <li class="task-list-item">
        <input type="checkbox" class="task-list-item-checkbox" disabled checked="checked"> Task 2</li>
        </ul>
      EXPECTED
